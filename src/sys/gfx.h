...
// === structs
typedef struct { uint32_t data[8];  } tile4_t; //!< 4bpp tile
typedef struct { uint64_t data[8]; } tile8_t; //!< 8bpp tile

typedef struct { uint16_t x, y; } ALIGN(4) u16pt_t;
...
typedef struct
{
	uint16_t fill0[3];	int16_t pa;
	uint16_t fill1[3];	int16_t pb;
	uint16_t fill2[3];	int16_t pc;
	uint16_t fill3[3];	int16_t pd;
